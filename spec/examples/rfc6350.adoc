...
<<ISO.8601>>.  Multiple such values can be specified using the
...
* [[[RFC3986,IETF RFC 3966]]], H. Schulzrinne. _The tel URI for Telephone Numbers._ 2004. https://www.rfc-editor.org/info/rfc3966
